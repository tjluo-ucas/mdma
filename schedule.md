---
title: "课程安排"
description: "2026 MDMA九天密集课程的模块、案例、问题导向活动和前沿延伸。"
lang: zh-CN
...
<section class="page-hero"><div class="page-hero-inner"><p class="eyebrow">Intensive schedule</p><h1>九天，六类管理决策</h1><p>每天从业务冲突开始，经模型和验证形成建议；方法名是解决问题后的知识总结，不是课堂起点。</p></div></section>
...
- C2：预测需求曲线与定价决策损失是否一致；
- C3/C4：名义最优对供应、成本和需求扰动是否稳健；
- C5：MIP Gap、近优方案和管理者可接受的选择集合；
- C6：仿真、随机优化、Value of Information 与决策阈值；
- 结课：模型漂移、责任分配、AI辅助与人工批准 Gate。

<div class="notice"><strong>GE规则</strong>正式列表为GE1–GE5，均为时间允许时开展且不计分；6/25是GE2 revisited。未开展不能记为缺交，答案解禁必须单独建模。</div>
</div>
