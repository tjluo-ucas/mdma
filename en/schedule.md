---
title: "Schedule"
description: "The 2026 nine-day MDMA intensive: modules, cases, problem-oriented activities, and frontier lenses."
lang: en
...
<section class="page-hero"><div class="page-hero-inner"><p class="eyebrow">Intensive schedule</p><h1>Nine days, six management decisions</h1><p>Each day starts with a business conflict, then moves through a model and verification to a recommendation. Method names summarize learning; they do not start it.</p></div></section>
<div class="content-shell" markdown="1">

## Approved intensive path
...
## Frontier lenses (without changing graded cases)

- C2: does demand-prediction error align with pricing decision loss?
- C3/C4: is the nominal optimum robust to supply, cost, and demand perturbations?
- C5: MIP gaps, near-optimal alternatives, and manager-acceptable choice sets;
- C6: simulation, stochastic decisions, value of information, and decision thresholds;
- synthesis: drift, accountability, AI assistance, and human approval gates.

<div class="notice"><strong>GE policy</strong>The approved list is GE1–GE5, offered only if time permits and ungraded; June 25 is GE2 revisited. A GE not offered is not missing work, and solution release is a separate state.</div>
</div>
